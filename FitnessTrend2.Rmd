...
# Visualize
age and sex fall in line with expectations, so graphing race because has most interesting insights
...
meeting guidelines might be too strict, looking at general inactivity
```{r}
...
data_inactive_geo_2019_1 <- data_physact2_2019 %>% 
  filter(fitness_category == 'Percent of adults who engage in no leisure-time physical activity')

data_inactive_geo_2019 <- left_join(fifty_states,data_inactive_geo_2019_1, by='state_desc')
```
